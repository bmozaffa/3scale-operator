...
// Generator implements the loop to generate template object
func Generator(adapterList []adapters.Adapter) *templatev1.Template {
	tpl := basicTemplate()
...
func basicTemplate() *templatev1.Template {
